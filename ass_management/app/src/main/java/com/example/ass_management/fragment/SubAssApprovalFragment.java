...
import com.example.ass_management.ApprovalActActivity;
...
import com.example.ass_management.adapter.SubAssApprovalAdapter;
...
/**
 * @author Barrie
 * @create 2022-05-13 22:28
 */
public class SubAssApprovalFragment extends BaseFragment {
    private static final String TAG = SubAssApprovalFragment.class.getSimpleName();
    private ListView mListView;
    private SubAssApprovalAdapter adapter;
    ...
    protected View initView() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                staticActivity = new Activity();
                staticActivity = activity;
                Log.e(TAG,"进入修改");
                startActivity(new Intent(getActivity(), ApprovalActActivity.class));}
        });
//        initData();
        return view;
    }
...
//        adapter = new FirstFragmentAdapter(mContext,datas);
        ...
        ocaBillsMutableLiveData.observe(this, new Observer<List<Activity>>() {
            ...
            public void onChanged(List<Activity> activities) {
                adapter = new SubAssApprovalAdapter(mContext,activities);
                mListView.setAdapter(adapter);
            }
        });
